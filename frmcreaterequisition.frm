...
End Sub
Sub Calculate_Total()
    Dim total As Double, amt As Double, discount As Double, Price As Double, qnty As Integer
        ...
        If .ListItems.Count > 0 Then
            ...
            For I = 1 To ccount
                With .ListItems(I)
                        ...
                        amt = Price * qnty
                        discount = CDbl(.ListSubItems(8))
                        total = total + amt - discount
                End With
            Next I
...
Private Sub cmdsave_Click()
   Dim PNo As Double, ReceiptNo As String, lenght As Integer
    ...
    MAKE As String, q As Double, DocumentNo As String, doc_posted As Integer, Totalprice, discount, Pprice As Double
    If lvwrequisition.ListItems.Count > 0 Then
    ...
    For I = 1 To lvwrequisition.ListItems.Count
        ...
        discount = lvwrequisition.ListItems(I).SubItems(8)
        If I <> 1 Then
            ReceiptNo = ReceiptNo
        ...
        End If
            doc_posted = 0
                 ...
                 '********* SAVE REQUISITION ***********
                sql = ""
                sql = "d_sp_Requisition '" & ReceiptNo & "', '" & tdate & "','" & tdate & "', '" & CC & "', " & doc_posted & ",'" & RNAME & "', '" & MAKE & "', " & q & ", '" & DocumentNo & "','" & User & "'," & Pprice & ",'" & discount & "' "
