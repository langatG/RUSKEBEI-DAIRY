...
If cbovendors.Text = "" Then
    ...
    Exit Sub
End If
oSaccoMaster.ExecuteThis ("set dateformat dmy insert into  d_Invoice( InvId, RNo, Vendor, InvDate, DueDate, Amount, [Desc], auditid, auditdatetime, Paid)values('','" & txtLPOSerial & "','" & cbovendors & "','','" & DTPduedate & "','" & lvwselecteditems.SelectedItem.ListSubItems(3) & "','','" & User & "','" & Date & "','0')")
...
txtLPOSerial = lvwselecteditems.SelectedItem
