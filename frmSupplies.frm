...
Begin VB.Form frmSupplies 
   ...
   Begin VB.ComboBox cboDistrict 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmSupplies.frx":0004
      Left            =   2520
      List            =   "frmSupplies.frx":0014
      TabIndex        =   3
      Top             =   2280
      Width           =   3255
   End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cboBBranch 
         Height          =   315
         ItemData        =   "frmSupplies.frx":0043
         Left            =   2400
         List            =   "frmSupplies.frx":0045
         TabIndex        =   21
         Top             =   1920
         Width           =   4695
      End
      Begin VB.ComboBox cboBankName 
         Height          =   315
         ItemData        =   "frmSupplies.frx":0047
         Left            =   2400
         List            =   "frmSupplies.frx":0049
         TabIndex        =   19
         Top             =   600
         Width           =   4695
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbocontcode 
         Height          =   315
         ItemData        =   "frmSupplies.frx":004B
         Left            =   8160
         List            =   "frmSupplies.frx":005B
         TabIndex        =   92
         Top             =   3960
         Width           =   1695
      End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox cbostatus 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmSupplies.frx":0344
            Left            =   10800
            List            =   "frmSupplies.frx":035A
            Locked          =   -1  'True
            TabIndex        =   82
            Text            =   "New"
            Top             =   720
      ...
      Begin VB.ComboBox cbobrnch 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "frmSupplies.frx":0654
         Left            =   2400
         List            =   "frmSupplies.frx":065B
         TabIndex        =   7
         Top             =   4200
         Width           =   3255
      End
      ...
      Begin VB.ComboBox cboTCode 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmSupplies.frx":066C
         Left            =   7920
         List            =   "frmSupplies.frx":066E
         TabIndex        =   14
         Top             =   3000
         Visible         =   0   'False
         Width           =   1935
      ...
      Begin VB.ComboBox cboType 
         Height          =   315
         ItemData        =   "frmSupplies.frx":12D8
         Left            =   7920
         List            =   "frmSupplies.frx":12E5
         TabIndex        =   16
         Top             =   3480
         Width           =   1935
      End
...
End If
End If
'If cboBankName = "MPESA" Then
'txtAccNumber = txtAccNumber
'End If
'Save to suppliers table
Set cn = New ADODB.Connection
sql = "d_sp_Suppliers " & txtSNo & ",'" & DTPregdate & "','" & txtIdNumber & "','" & txtNames & "','" & txtAccNumber & "' ,'" & cboBankName & "','" & cboBBranch & "','" & cboType & "','" & txtVillage & "','" & cboLocation & "','" & txtDivision & "','" & cboDistrict & "'," & Trader & "," & Active & ",0," & Shares & ",'" & cbobrnch & "','" & txtPNumber & "','" & txtPAddress & "','" & txtTown & "','" & txtEMail & "','" & cboTCode & "','" & "Sign" & "','" & "Photo" & "','" & User & "','" & cbocontcode & "','" & txtaartkno & "','" & dtptmd & "'," & thcp & "," & thcpactive & "," & txtthcppremium
...
txtthcppremium = 0
sql = ""
sql = "update d_Suppliers set TYPES=null,tmd=null,status1=0,shares=" & Shares & " where sno='" & txtSNo & "'"
oSaccoMaster.ExecuteThis (sql)
...
'If rst.EOF Then
'MsgBox "UPDATE BONUS TO THE MEMBER"
...
'If Not IsNull(rs.Fields(23)) Then txtaartkno = rs.Fields(23)
