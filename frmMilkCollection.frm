...
Begin VB.Form frmMilkCollection 
   ...
   Begin VB.CommandButton cmdtrans 
      ...
      Width           =   3255
   End
   Begin VB.CommandButton cmdcompla 
   ...
   Begin VB.ComboBox ports 
      ...
      TabIndex        =   30
      Text            =   "\\127.0.0.1\E-PoS printer driver"
      Top             =   1920
      Width           =   2175
   End
...
Set cn = New ADODB.Connection
sql = "d_sp_MilkIntake " & txtSNo & ",'" & DTPMilkDate & "'," & Round(txtQnty, 1) & "," & Price & "," & Price * CCur(txtQnty) & ",'" & Time & "','" & User & "','Intake','" & txtcomment & "'"
oSaccoMaster.ExecuteThis (sql)
