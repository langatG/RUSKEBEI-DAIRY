...
Private Sub cmdExport_Click()
  ...
  NAMES = txtName
    ...
    If lvwEnguery.ListItems.Count > 0 Then
        ...
        strData = "Transporter No  :" & sno
        MFile.WriteLine strData
        strData = "Transporter Name:" & NAMES
        MFile.WriteLine strData
        strData = "---------------------------------------------"
        MFile.WriteLine strData
        strData = ""
        'strData = "Period for" - "& dtpFrom &" & "to" & "& dtpto &"
        strData = "Transdate,Description ,CREDIT,DEBIT,Balance"
...
'            MFile.WriteLine strData
            strData = li & "," & li.SubItems(1) & "," & CDbl(li.SubItems(2)) _
