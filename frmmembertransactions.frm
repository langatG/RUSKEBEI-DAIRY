...
Begin VB.Form frmmembertransactions 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(2)=   "Cmdjv"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "cmdsave"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "Frame2"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "cmdreverse"
      ...
      Tab(1).Control(1)=   "cmdprintstatement"
...
Set rs = CreateObject("adodb.recordset")
sql = ""
sql = "select * from useraccounts where passwords='" & txtPassword & "' and userloginid='" & User & "'"
rs.Open sql, cn
