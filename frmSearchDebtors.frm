...
Begin VB.Form frmSearchDebtors 
   Caption         =   "Search"
   ClientHeight    =   4980
   ClientLeft      =   60
   ClientTop       =   450
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   495
         Left            =   3240
         Picture         =   "frmSearchDebtors.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Cancel"
         Top             =   4080
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   375
            Left            =   2400
            Picture         =   "frmSearchDebtors.frx":0102
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   240
            Width           =   375
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchDebtors.frx":0204
         Left            =   2280
         List            =   "frmSearchDebtors.frx":021D
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      Begin VB.ComboBox cboField 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchDebtors.frx":0241
         Left            =   120
         List            =   "frmSearchDebtors.frx":0243
         TabIndex        =   2
         Top             =   360
         Width           =   2055
      End
      Begin VB.CommandButton cmdRef 
         Height          =   495
         Left            =   3840
         Picture         =   "frmSearchDebtors.frx":0245
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Refresh"
         Top             =   4080
   ...
   End
End
Attribute VB_Name = "frmSearchDebtors"
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT   dcode,dname   FROM    d_Debtors  where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
...
Set li = frmSearchDebtors.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT   dcode,dname   FROM    d_Debtors  where " & cboField & " LIKE '%" & txtFrom & "%' ORDER BY DCode"
            'Else
            'end if
           CConnect.Openrs
...
Set li = frmSearchDebtors.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        Else
            If cboField.Text = "DCode" Then
                sql = "SELECT   dcode,dname   FROM    d_Debtors  where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "SELECT   dcode,dname   FROM    d_Debtors  where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Private Sub Form_Load()
    With frmSearchDebtors.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Debtors Code", 1500
        .ColumnHeaders.Add , , "Debtors Names", 2800
        .View = lvwReport
        .GridLines = True
    End With
    With frmSearchDebtors.cboField
        .AddItem "Dcode"
        .AddItem "Dname"
    ...
    CConnect.cnnConnect
    sql = "SELECT   dcode,dname   FROM    d_Debtors ORDER BY dcode"
    CConnect.Openrs
    With rs
        If .RecordCount > 0 Then
            .MoveFirst
...
lstSearch.ListItems.Clear
    ...
    CConnect.cnnConnect
   sql = "SELECT     dcode,dname FROM    d_Debtors ORDER BY dname"
    CConnect.Openrs
