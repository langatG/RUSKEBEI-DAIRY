...
sql = ""
sql = "d_sp_UpdateCProfile'" & txtCompanyName & "','" & txtPostalAddress & "','" & txtTown & "','" & txtCountry & "','" & txtProvince & "','" & txtDistrict & "','" & txtDivision & "','" & txtLocation & "','" & txtFax & "','" & txtPhone & "','" & txtEMail & "','" & txtWebsite & "','" & User & "'"
...
txtEMail = rs!Email
txtFax = IIf(IsNull(rs!FaxNo), "NA", rs!FaxNo)
txtLocation = rs!Location
txtPhone = rs!PhoneNo
txtPostalAddress = rs!Adress
txtProvince = rs!Province
txtTown = rs!town
txtWebsite = IIf(IsNull(rs!Website), "NA", rs!Website)
